...
def chords_are_repeated_too_much(next_chord_index, last_chord_index, chord_indexes_used)
	return next_chord_index == chord_indexes_used[last_chord_index] && 
	next_chord_index == chord_indexes_used[last_chord_index - 1]
end
...
puts build_progression(ARGV[0].to_i)
